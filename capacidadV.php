...
<html lang="en">
  ...
  <body>
    <center><b><h1>CONVERSIÓN DE CAPACIDAD</h1></b>
    <b><h2>Elija la unidad a convertir</h2></b></center>
    ...
    <button class="btn btn-success" onclick="location.href='index.php'">Menú principal</button></center></center>
    <?php
